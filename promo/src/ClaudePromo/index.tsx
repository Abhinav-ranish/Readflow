...
import tinyPawsSrc from "../../tiny-paws-by-sakura-girl.mp3";
...
export const ReadflowPromo: React.FC = () => {
  ...
  return (
    ...
    >
      <Audio src={tinyPawsSrc} volume={musicVolume} startFrom={0} />
      {/* Scene 1: Hook text */}
      <Sequence from={0} durationInFrames={90}>
        <SceneHook />
      </Sequence>

      {/* Scene 2: The prompt — user asks Claude */}
      <Sequence from={90} durationInFrames={75}>
        <ScenePrompt />
      </Sequence>

      {/* Scene 3: AI working montage */}
      <Sequence from={165} durationInFrames={165}>
        <SceneWorking />
      </Sequence>

      {/* Scene 4: Done — the link */}
      <Sequence from={330} durationInFrames={90}>
        <SceneDone />
      </Sequence>

      {/* Scene 5: The Readflow result */}
